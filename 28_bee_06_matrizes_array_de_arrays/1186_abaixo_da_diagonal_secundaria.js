...
function main() {
    ...
    operacao === 'S' ? 
    somar_elementos_abaixo_da_diagonal_secundaria(matriz) :
    extrair_media_elementos_abaixo_da_diagonal_secundaria(matriz)

    console.log(resultado_operacao.toFixed(1))
}

function somar_elementos_abaixo_da_diagonal_secundaria(matriz) {
    ...
    for(let i = 0; i < matriz.length; i++) {
        for(let j = 0; j < matriz[i].length; j++) {
            ...
            if(esta_abaixo_da_diagonal_secundaria(i, j, ordem)) {
                soma+= matriz[i][j]
            }
        }
    }
...
function extrair_media_elementos_abaixo_da_diagonal_secundaria(matriz) {
    const soma = somar_elementos_abaixo_da_diagonal_secundaria(matriz)
